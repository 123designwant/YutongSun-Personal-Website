...
const CONTENT_PRACTICES = [
  {
    ...
    summary:
      "具备精准的用户情绪捕获与全链路操盘能力。独立策划、排版并落地高质量纸质实物，驱动社群粉丝增长率达 1900%。",
    sections: [
      {
        title: "D1：用户洞察",
        text: "通过社群观察发现，粉丝群体对纸质媒介、访谈文字和歌词有较强依赖, 因此决定采用纸质版实物, 既是文青偏爱的文艺复古, 又兼具了文字的传达和陪伴。",
      },
      {
        title: "D2：内容策划与后续协调",
        text: "围绕成长、孤独、选择等主题，独立完成数万字访谈与演出素材的筛选、图片选取和文字整理，并独立负责视觉设计与整体排版适配；独立对接印刷供应商，把控尺寸、纸张与交付日期。",
      },
      {
        title: "D3：最终成果",
        text: "抓住演唱会IP的时间节点和热度，报纸热度持续一周，一周内粉丝量提升30倍，线上热度是官方粉丝账号的三倍。首批 500 份迅速交付完成，后续追加印制 2000 份。",
      },
    ],
    pitch:
      "备敏锐的商业嗅觉与端到端的闭环执行力。能够依托用户洞察抓准营销节点，将无形的情绪诉求转化为高质量的实体产品，实现口碑与数据的双赢。",
  },
  {
    id: "answer-book",
    caseNo: "PRACTICE 02",
    title: "“答案之书”互动网页",
    subtitle: "把情感诉求转化为线上互动",
    type: "线上互动产品",
    // 换成淡色系的书本/桌面
    cover:
    ...
    isInteractive: true,
    summary:
      "具备优秀的 AIGC 落地应用能力。上线半月独立访客 2000+，全项目累计触达用户 4000+。",
    sections: [
      {
        title: "D1：需求洞察",
        text: "抓取用户喜爱线上互动和渴望情感安抚的特点，设计 140 条文案，通过答案之书的输入和随机翻页动效，强化获取答案和互动的仪式感。",
      },
      {
        title: "D2： AIGC 协助工作",
        text: "独立完成需求拆解、主题聚类、文案生成等任务, 运用 GPT、Claude 等工具，辅助代码和调整，完成页面开发和校准；也是一个vibecoding的应用和落地项目。",
      },
      {
        title: "D3：成果反馈",
        text: "发布后经社群自然传播，上线半月点击率破两千，用户平均停留时间大于2分钟。",
      },
    ],
    pitch:
      "具备敏捷的产品思维与提示词工程能力。通过精准设计工作流，将模糊的情感诉求转化为可交互的线上产品，完成个人效能的杠杆式跃升。",
  },
  {
    id: "debate-team",
    caseNo: "EXP 02",
    ...
    tags: ["架构搭建", "活动统筹", "团队管理"],
    summary:
      "具备从 0 到 1 的系统架构与大型活动统筹能力。独立完成校队规划搭建，统筹 500 人规模市级赛事。",
    sections: [
      {
...
const DATA_RESEARCH = [
  {
    ...
    summary:
      "具备扎实的统计学底蕴与业务策略转化能力。构建流失预测、用户分群与干预优化的分析框架，设计最优策略，预计平均挽留成功率达 61.7%。",
    sections: [
      {
        title: "D1：数据处理",
        text: "面对 1 万名游戏用户、90 万条日行为日志、7千多条付费记录和 三万五千多条好友关系数据，使用 SQL / Python 完成清洗与处理，提取流失前兆特征。",
      },
      {
        title: "D2：用户分层",
  ...
  },
  {
    ...
    pitch:
      "具备快速学习与执行能力。能够将前沿的理论逻辑，迅速转化为高质量的代码与切实可行的落地算法。",
  },
];
...
const ABILITIES_DATA = [
  {
    ...
    summary:
      "具备极强的 AI 工具栈驾驭能力与任务拆解思维。能够通过分阶段 Prompt 设计，将 AI 接入内容生成、逻辑推导与代码辅助，实现个人能效的指数级跃升。",
  },
  {
    id: "ab-data",
    caseNo: "SKILL 02",
    ...
    summary:
      "具备扎实的数理统计底盘与全链路数据处理能力。熟练运用 Python/SQL/SPSS 完成多源数据清洗与特征工程，并掌握 PyTorch 框架进行复杂建模架。",
  },
  {
    id: "ab-content",
    caseNo: "SKILL 03",
