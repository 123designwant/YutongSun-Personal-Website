...
const CONTENT_PRACTICES = [
  {
    ...
    tags: ["用户洞察", "纸媒设计", "内容策划"],
    summary:
      "围绕演唱会前后的情绪节点，完成《时寐日报》的内容策划、视觉排版、印刷与对接。一周内小红书账号粉丝量增长约 20 倍，相关内容热度达到官方粉丝账号约 3 倍。",
    sections: [
      {
        title: "D1：用户洞察",
  ...
  },
  {
    ...
    sections: [
      {
        title: "D1：互动设计",
        text: "将“提问 - 等待 - 翻页 - 获得答案”的过程设计成一条低门槛互动路径，让用户在很短时间内完成一次带有仪式感的情绪回应。",
      },
      {
...
const DATA_RESEARCH = [
  {
    ...
    summary:
      "围绕手游用户活跃下降问题，构建“流失预测 - 用户分群 - 干预优化”的运营分析框架，最终方案预计平均挽留成功率达 61.7%。",
    sections: [
      {
        title: "D1：数据处理",
        text: "使用 SQL 与 Python 清洗并整理 1 万名用户、90 万条日行为日志、7872 条付费记录和 35082 条好友关系数据，提取登录、付费、社交等维度的关键特征，用于捕捉流失前兆。",
      },
      {
        title: "D2：用户分层",
  ...
  },
  {
    ...
    sections: [
      {
        title: "D1：理论推导",
        text: "基于连续时间金融理论完成动态投资组合模型推导，并将理论公式转化为可运行的强化学习算法流程。",
      },
      {
        title: "D2：算法环境搭建",
    ...
    pitch:
      "论文，最重要的不是把公式写完，而是把模型真正应用到实地；研究真的有意义。",
  },
];
...
const INTERNSHIPS_ORG = [
  {
    ...
    sections: [
      {
        title: "用户需求拆解",
        text: "参与心理测评、品牌满意度、餐饮消费、医疗健康等多类型数据分析项目，根据客户研究目的，将模糊需求拆解为可分析的问题框架，例如用户画像、满意度影响因素、消费偏好和群体差异对比。",
      },
      {
        title: "数据处理与分析",
        text: "使用 SPSS、Excel、R 完成描述性统计、主成分分析、显著性检验等分析工作，并使用 Python / SQL 进行数据清洗、字段筛选和基础查询。三个月内经手 200+ 份数据，正确率达到99%。",
      },
      {
        title: "结果整理与报告交付",
        text: "将分析结果整理为结构化报告，提炼关键发现、用户差异和潜在优化方向，帮助客户理解数据背后的问题，并为用户分层、内容优化、产品体验改进和运营策略制定提供参考；相关项目客户满意度高于 90%。",
      },
    ],
  },
];
...
const ABILITIES_DATA = [
  {
    ...
    caseNo: "SKILL 01",
    title: "AIGC",
    subtitle: "将AI大模型深度融入工作与研发流",
    theme: "bg-[#FAFAFA]",
    tags: ["GPT", "Claude", "Gemini", "AI Workflow"],
    summary:
      "熟悉各类主流AI提示词特点，能将其深度应用于内容策划、代码开发和数据处理环节，并具备结果的校验把控能力。",
  },
  {
    id: "ab-data",
    caseNo: "SKILL 02",
